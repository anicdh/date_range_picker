      ...
      child: new _DateHeaderButton(
        ...
        child: new Semantics(
            ...
            child: new Row(
              ...
              children: <Widget>[
                new Text(localizations.formatYear(selectedFirstDate), style: yearStyle),
                selectedLastDate != null ?
                new Text(localizations.formatYear(selectedLastDate), style: yearStyle)
                    : new Container(),
              ],
            )
        ),
      ...
      child: new _DateHeaderButton(
        ...
        child: new Semantics(
            ...
            child: new Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                new Text(localizations.formatMediumDate(selectedFirstDate), style: dayStyle, textScaleFactor: 0.6,),
                selectedLastDate != null ?
                new Text(localizations.formatMediumDate(selectedLastDate), style: dayStyle, textScaleFactor: 0.6,)
                    : new Container(),
              ],
            )
        ),
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        final bool isSelectedLastDay = selectedLastDate != null ? (selectedLastDate.year == year && selectedLastDate.month == month && selectedLastDate.day == day) : null;
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return new InkWell(
          ...
          onTap: () {
            ...
            if (widget.selectedLastDate == null) {
              DateTime newDate = new DateTime(year, widget.selectedFirstDate.month, widget.selectedFirstDate.day);
              changes = [newDate, newDate];
            } else {
              changes = [new DateTime(year, widget.selectedFirstDate.month, widget.selectedFirstDate.day), null];
            }
...
Future<List<DateTime>> showDatePicker({
  ...
  assert(
  selectableDayPredicate == null || selectableDayPredicate(initialFirstDate) || selectableDayPredicate(initialLastDate),
